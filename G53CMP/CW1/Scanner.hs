...
--        scan l c ('\'' : s) = retTkn LitChar l c (c + 1) s
        ...
        mkIdOrKwd "repeat"  = Repeat      -- TASK I.1
        mkIdOrKwd "until"   = Until       -- TASK I.1
        mkIdOrKwd "elsif"   = Elsif       -- TASK I.3
